...
Image = (function(superClass) {
  ...
  Image.prototype.mixins = [];

  Image.prototype.props = function() {
    return _.extend({}, Image.__super__.props.call(this), {
      image: [p.NumberSpec],
      dw: [p.NumberSpec],
      dh: [p.NumberSpec],
      dilate: [p.Bool, false],
      color_mapper: [
        p.Instance, new LinearColorMapper.Model({
          palette: Greys9
        })
      ]
    });
  ...
  Image.prototype.initialize = function(attrs, options) {
    Image.__super__.initialize.call(this, attrs, options);
