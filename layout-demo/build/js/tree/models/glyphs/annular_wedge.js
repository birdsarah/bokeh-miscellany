...
AnnularWedgeView = (function(superClass) {
  ...
  AnnularWedgeView.prototype._render = function(ctx, indices, arg) {
    ...
    sx = arg.sx, sy = arg.sy, start_angle = arg.start_angle, angle = arg.angle, sinner_radius = arg.sinner_radius, souter_radius = arg.souter_radius;
    ...
    for (j = 0, len = indices.length; j < len; j++) {
      ...
      ctx.arc(0, 0, sinner_radius[i], 0, -angle[i], !direction);
      ctx.closePath();
  ...
  AnnularWedgeView.prototype._hit_point = function(geometry) {
    var angle, candidates, direction, dist, hits, i, ir2, j, k, len, len1, or2, pt, ref, ref1, ref2, ref3, ref4, result, sx, sx0, sx1, sy, sy0, sy1, vx, vx0, vx1, vy, vy0, vy1, x, x0, x1, y, y0, y1;
    ...
    for (k = 0, len1 = candidates.length; k < len1; k++) {
      ...
      if (angle_between(-angle, -this.start_angle[i], -this.end_angle[i], direction)) {
        hits.push([i, dist]);
      }
    }
...
AnnularWedge = (function(superClass) {
  ...
  AnnularWedge.prototype.props = function() {
    return _.extend({}, AnnularWedge.__super__.props.call(this), {
