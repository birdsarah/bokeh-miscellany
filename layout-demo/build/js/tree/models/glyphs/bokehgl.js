...
attach_float = function(prog, vbo, att_name, n, visual, name) {
  var a;
  vbo.used = true;
  if (visual[name].spec.value != null) {
...
attach_color = function(prog, vbo, att_name, n, visual) {
  ...
  m = 4;
  vbo.used = true;
  if ((visual.color.spec.value != null) && (visual.alpha.spec.value != null)) {
    rgba = color2rgba(visual.color.spec.value, visual.alpha.spec.value);
    prog.set_attribute(att_name, 'vec4', null, rgba);
    vbo.used = false;
  } else {
    if (visual.color.spec.value != null) {
      colors = (function() {
        var l, ref, results;
        results = [];
        for (i = l = 0, ref = n; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
          results.push(visual.color.spec.value);
        }
        return results;
      })();
    } else {
    ...
    if (visual.alpha.spec.value != null) {
