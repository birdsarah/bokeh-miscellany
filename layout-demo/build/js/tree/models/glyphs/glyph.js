var CategoricalMapper, Glyph, GlyphView, Model, Renderer, _, bbox, p, rbush,
  ...
  GlyphView.prototype.initialize = function(options) {
    ...
    if (((ref = this.renderer) != null ? ref.plot_view : void 0) != null) {
      ...
      if (ctx.glcanvas != null) {
        return this._init_gl(ctx.glcanvas.gl);
      }
    }
  };
...
Glyph = (function(superClass) {
  ...
  Glyph.prototype.mixins = ['line', 'fill'];

  Glyph.prototype.props = function() {
    return _.extend({}, Glyph.__super__.props.call(this), {
      visible: [p.Bool, true]
    });
  };
