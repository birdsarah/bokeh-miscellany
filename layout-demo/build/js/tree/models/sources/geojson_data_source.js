...
GeoJSONDataSource = (function(superClass) {
  ...
  GeoJSONDataSource.prototype.props = function() {
    return _.extend({}, GeoJSONDataSource.__super__.props.call(this), {
      geojson: [p.Any],
      data: [p.Any, {}]
    });
  };
  ...
  GeoJSONDataSource.prototype.geojson_to_column_data = function() {
    var coord_list, coords, data, exterior_ring, exterior_rings, flatten_function, flattened_coord_list, geojson, geometry, i, item, items, j, k, l, len, len1, len2, len3, len4, len5, m, n, o, polygon, property, q, ref, ref1, ref2, ref3, ref4, ref5, ref6;
    ...
    for (i = k = 0, len = items.length; k < len; i = ++k) {
      ...
      switch (geometry.type) {
        ...
        case "MultiPolygon":
          ...
          for (j = q = 0, len5 = flattened_coord_list.length; q < len5; j = ++q) {
            coords = flattened_coord_list[j];
            data.xs[i][j] = coords[0];
            data.ys[i][j] = coords[1];
