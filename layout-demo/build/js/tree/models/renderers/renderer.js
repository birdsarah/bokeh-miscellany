var Backbone, BokehView, Model, Renderer, RendererView, VISUALS, _, _ContextProperties, _Fill, _Line, _Text, array_max, logger, mixins, p, proj4, toProjection,
  ...
  RendererView.prototype.set_data = function(source) {
    ...
    for (name in ref) {
      ...
      if (prop instanceof p.Distance) {
        this["max_" + name] = array_max(this[name]);
      }
    }
...
Renderer = (function(superClass) {
  ...
  Renderer.prototype.coords = [];

  Renderer.prototype.props = function() {
    return _.extend({}, Renderer.__super__.props.call(this), this._coords());
  };

  Renderer.prototype._coords = function() {
