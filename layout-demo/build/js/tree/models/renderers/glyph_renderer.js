...
GlyphRendererView = (function(superClass) {
  ...
  GlyphRendererView.prototype.initialize = function(options) {
    var attrs, decimated_glyph, glyph_attrs, hover_glyph, nonselection_glyph, selection_glyph;
    GlyphRendererView.__super__.initialize.call(this, options);
    this.glyph = this.build_glyph_view(this.mget("glyph"));
    glyph_attrs = _.omit(_.clone(this.mget("glyph").attributes), 'id');
    selection_glyph = this.mget("selection_glyph");
    if (selection_glyph == null) {
      attrs = _.extend({}, glyph_attrs, this.model.selection_defaults);
      selection_glyph = new (this.mget("glyph")).constructor(attrs);
    }
    this.selection_glyph = this.build_glyph_view(selection_glyph);
    nonselection_glyph = this.mget("nonselection_glyph");
    if (nonselection_glyph == null) {
      attrs = _.extend({}, glyph_attrs, this.model.nonselection_defaults);
      nonselection_glyph = new (this.mget("glyph")).constructor(attrs);
    }
    ...
    attrs = _.extend({}, glyph_attrs, this.model.decimated_defaults);
    decimated_glyph = new (this.mget("glyph")).constructor(attrs);
...
GlyphRenderer = (function(superClass) {
  ...
  GlyphRenderer.prototype.props = function() {
    return _.extend({}, GlyphRenderer.__super__.props.call(this), {
