...
DynamicImageView = (function(superClass) {
  ...
  DynamicImageView.prototype._set_rect = function() {
    ...
    outline_width = this.plot_model.properties.outline_line_width.value();
...
DynamicImageRenderer = (function(superClass) {
  ...
  DynamicImageRenderer.prototype.props = function() {
    return _.extend({}, DynamicImageRenderer.__super__.props.call(this), {
      alpha: [p.Number, 1.0],
