var ALPHABETIC, Axis, AxisView, CENTER, GuideRenderer, HANGING, LEFT, LayoutBox, MIDDLE, RIGHT, Renderer, _, _align_lookup, _align_lookup_negative, _align_lookup_positive, _angle_lookup, _apply_location_heuristics, _baseline_lookup, kiwi, logger, p, pi2,
...
Axis = (function(superClass) {
  ...
  Axis.prototype.mixins = ['line:axis_', 'line:major_tick_', 'line:minor_tick_', 'text:major_label_', 'text:axis_label_'];

  Axis.prototype.props = function() {
    return _.extend({}, Axis.__super__.props.call(this), {
      visible: [p.Bool, true],
