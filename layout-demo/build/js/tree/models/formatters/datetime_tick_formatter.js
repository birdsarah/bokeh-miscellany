var DatetimeTickFormatter, SPrintf, TickFormatter, _, _array, _four_digit_year, _strftime, _two_digit_year, _us, logger, p, tz,
...
DatetimeTickFormatter = (function(superClass) {
  ...
  DatetimeTickFormatter.prototype.props = function() {
    return _.extend({}, DatetimeTickFormatter.__super__.props.call(this), {
      formats: [p.Any, {}]
    });
  };
