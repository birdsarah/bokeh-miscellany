var Numeral, NumeralTickFormatter, TickFormatter, _, p,
...
NumeralTickFormatter = (function(superClass) {
  ...
  NumeralTickFormatter.prototype.props = function() {
    return _.extend({}, NumeralTickFormatter.__super__.props.call(this), {
      format: [p.String, '0,0'],
