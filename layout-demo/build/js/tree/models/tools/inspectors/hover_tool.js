var $, HoverTool, HoverToolView, InspectTool, Tooltip, Util, _, _color_to_hex, hittest, logger, p,
...
HoverTool = (function(superClass) {
  ...
  HoverTool.prototype.props = function() {
    return _.extend({}, HoverTool.__super__.props.call(this), {
