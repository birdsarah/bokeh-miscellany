var Annotation, BoxAnnotation, BoxAnnotationView, Renderer, _, p,
...
BoxAnnotation = (function(superClass) {
  ...
  BoxAnnotation.prototype.mixins = ['line', 'fill'];

  BoxAnnotation.prototype.props = function() {
    return _.extend({}, BoxAnnotation.__super__.props.call(this), {
