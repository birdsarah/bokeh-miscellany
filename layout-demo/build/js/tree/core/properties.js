var Anchor, Angle, AngleSpec, Any, Array, Backbone, Bool, Color, ColorSpec, Dimension, Direction, DirectionSpec, Distance, DistanceSpec, Font, FontSizeSpec, FontStyle, Instance, LegendLocation, LineCap, LineJoin, Location, Number, NumberSpec, Orientation, Property, RenderLevel, RenderMode, SpatialUnits, String, StringSpec, TextAlign, TextBaseline, _, enum_prop, enums, simple_prop, svg_colors, units_prop, valid_rgb,
...
Property = (function(superClass) {
  ...
  Property.prototype.value = function() {
    ...
    return this.transform([this.spec.value])[0];
  };
  ...
  Property.prototype.array = function(source) {
    ...
    if (this.spec.field != null) {
      if (this.spec.field in data) {
        return this.transform(source.get_column(this.spec.field));
      } else {
