var $, Backbone, HasProps, _, logger, mixins, refs,
...
HasProps = (function(superClass) {
  ...
  HasProps.prototype.props = function() {
    return mixins.create(this.mixins);
  };
  ...
  function HasProps(attributes, options) {
    ...
    var attrs, default_value, defaults, name, props, ref, type;
    this.document = null;
    attrs = attributes || {};
    if (!options) {
      options = {};
    ...
    for (name in props) {
      ref = props[name], type = ref[0], default_value = ref[1];
  ...
  HasProps.prototype.set = function(key, value, options) {
    var attrs, old, resolve_refs, results, val;
  ...
  HasProps.prototype.attach_document = function(doc) {
    var c, first_attach, j, len, name, prop, ref, ref1, results;
