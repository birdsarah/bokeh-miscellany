...
def bollinger():
    ...
    p = figure(x_axis_type='datetime', tools=tools, responsive='box')
...
def slider():
    ...
    plot = figure(y_range=(-10, 10), tools='', toolbar_location=None, responsive='box')
...
def linked_panning():
    ...
    s2 = figure(tools=tools, toolbar_location='right', x_range=s1.x_range, y_range=s1.y_range, responsive='box')
...
def linked_brushing():
    ...
    s1 = figure(tools='pan, box_select', toolbar_location='right', min_border=5, responsive='box')
    s1.circle('x', 'y1', line_color=None, fill_alpha=0.6, source=source)
    s2 = figure(tools='pan, box_select', toolbar_location='right', x_range=s1.x_range, y_range=s1.y_range, responsive='box')
